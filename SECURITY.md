...
| Version    | Supported          |
| -------    | ------------------ |
| 2026.2.x   | :white_check_mark: |

Please note that any security reports for a x.0.x (Alpha) will not be available for an immediate fix as development is still ongoing, should a serious issue arise please downgrade to the previous stable version
Older alpha and beta releases (below the last stable release) are not eligible for security updates
...
Subject: Security Report | StellaraeSecure

At the top of the body (optionally) include a longer description to fill in for the subject line as the above is mandatory for our filtering system
